...
const DeleteSubcategory: React.FC<DeleteSubcategoryModalProps> = ({ selectedSubcategoryData, setIsDeleteModalOpen }) => {
        ...
        >
            <div className="bg-white rounded-lg shadow-lg w-full max-w-2xl p-4 animate-in fade-in-0 zoom-in-95 overflow-y-auto max-h-[95%]">
                <div className='flex flex-col items-center justify-center pb-7'>
                    ...
                    <h3 className='text-xl font-normal mt-3 text-center'>You won't be able to revert this {selectedSubcategoryData.subcategory_name}!</h3>
